...
main() {
    ...
    while (i <= linhas) {  // Enquanto i for menor ou igual oa numero de linhas, o laço sera mantido
        ...
        while (j <= i) {  // Dentro de cada linha('i'), ira ser percorrido esse while
            ...
            printf("* "); // Esse laço vai exibir um asterisco, enquanto a quantidade de asteriscos('j') for menor que o tamanho da linha
